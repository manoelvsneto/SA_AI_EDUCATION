...
```mermaid
graph TD
    RQ3["<b>RQ3</b><br/>Learning and<br/>gap<br/>indications<br/>(N=57)"]
    
    C1["C1<br/>AI, cloud and<br/>modern<br/>architectures"]
    C2["C2<br/>Gain in<br/>understanding and<br/>confidence"]
    C3["C3<br/>Practical<br/>learning, projects<br/>and examples"]
    C4["C4<br/>Architectural<br/>decisions and<br/>systemic vision"]
    C5["C5<br/>Future application<br/>and professional<br/>context"]
    C6["C6<br/>Modeling as<br/>a learning<br/>tool"]
    ...
    C1 -.->|contextualizes| C3
    C3 -.->|favors| C2
    C2 -.->|prepares for| C5
    C4 -.->|projects into| C5
    C6 -.->|supports| C4

    style RQ3 fill:#d0d0d0
